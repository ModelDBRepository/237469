...
i = """+str(i)+"""
if (epnm.gid_exists(i)) {
  epnm.pc.gid2cell(i).soma """+str(myMechs[iMech])+""" = """+str(myMechs[iMech])+""" * """+str(blockEfficiency[0])+"""
  forsec epnm.pc.gid2cell(i).apical { """+str(myMechs[iMech])+""" = """+str(myMechs[iMech])+""" * """+str(blockEfficiency[1])+""" }
}""")
        print("""
i = """+str(i)+"""
if (epnm.gid_exists(i)) {
  ...
  forsec epnm.pc.gid2cell(i).apical { """+str(myMechs[iMech])+""" = """+str(myMechs[iMech])+""" * """+str(blockEfficiency[1])+""" }
        ...
        firstunderscore = myMechs[iMech].find('_')
        print("forall if(ismembrane(\""+str(myMechs[iMech][firstunderscore+1:])+"\")) { "+str(myMechs[iMech])+" = "+str(myMechs[iMech])+" * "+str(blockEfficiency)+" }")
        h("forall if(ismembrane(\""+str(myMechs[iMech][firstunderscore+1:])+"\")) { "+str(myMechs[iMech])+" = "+str(myMechs[iMech])+" * "+str(blockEfficiency)+" }")
        myMechToAdd = myMechToAdd+myMechs[iMech]+'x'+str(blockEfficiency)+'_'
    else:
...
""")
  ...
  file = open('spikes_parallel_'+myMechToAdd+str(nseg)+'_'+str(tstop)+'_'+str(mutID)+'_'+str(Econ)+'_'+str(Icon)+'_'+str(rateCoeff)+'_'+str(gNoiseCoeff)+'_'+str(gSynCoeff)+'_'+str(rdSeed)+'_'+str(rank)+'_of_'+str(Nmc)+'.sav', 'w')
